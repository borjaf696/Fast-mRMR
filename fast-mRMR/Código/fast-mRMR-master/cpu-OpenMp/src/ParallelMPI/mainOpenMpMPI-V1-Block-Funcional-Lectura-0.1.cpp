...
int main(int argc, char* argv[]) {
    ...
    MPI_Scatterv(rawData.getDataArray(),scountFeatures,displFeatures,MPI_CHAR,datos,send[0]*dataSizes, MPI_CHAR, 0, MPI_COMM_WORLD);
    ...
    while (etapas < opts.selectedFeatures) {
        ...
        #pragma omp parallel for schedule(dynamic,100) private(mrmr)
        ...
        MPI_Bcast(&featurePass, 1, MPI_INT, proceso, MPI_COMM_WORLD);
